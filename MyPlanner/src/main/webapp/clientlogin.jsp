...
<head>
    ...
    <title>MyPlanner - Client Login</title>
...
<div class="login-container px-4">
    <div class="max-w-md w-full fadeIn" style="animation-delay: 0.3s;">
        <!-- Login Card -->
        <div class="bg-white rounded-lg shadow-lg overflow-hidden login-card">
            <div class="p-8">
                <h2 class="text-2xl font-bold text-center text-gray-800 mb-6">Client Login</h2>
                
                <form action="loginclient" method="post" class="space-y-6">
                    <!-- Username Field -->
                    <div class="space-y-2">
                ...
                <!-- Vendor Login Button -->
                <div class="mb-4">
                    <a href="vendorlogin.jsp" class="block w-full text-center">
                        <button type="button"
                                class="btn-primary w-full py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 flex items-center justify-center">
                            <i class="fas fa-store mr-2"></i> Login as Vendor
                        </button>
                    </a>
                </div>
                ...
                <div>
                    <a href="addnewclient.jsp" class="block w-full text-center">
                        <button type="button"
        ...
        <!-- Footer Text -->
        <div class="text-center mt-6 text-sm text-gray-600 fadeIn" style="animation-delay: 0.5s;">
