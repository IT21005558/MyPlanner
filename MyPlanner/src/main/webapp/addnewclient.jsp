...
<head>
    ...
    <title>MyPlanner - Client Registration</title>
...
<main class="container mx-auto px-4 py-10">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 mt-2">Join MyPlanner and start planning your perfect events</p>
        </div>
        
        <!-- Registration Form Card -->
        <div class="bg-white rounded-lg shadow-md overflow-hidden form-section">
            <div class="p-8">
                <form action="registerclient" method="post" class="space-y-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex space-x-6 mt-1">
                                <div class="flex items-center">
                                    ...
                                    <label for="genderMale" class="ml-2 block text-sm text-gray-700">Male</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="radio" id="genderFemale" name="gender" value="Female" required
                                           class="h-4 w-4 text-indigo-600 border-gray-300 focus:ring-indigo-500">
                                    <label for="genderFemale" class="ml-2 block text-sm text-gray-700">Female</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-xs text-gray-500">You must be at least 18 years old to register</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6 pt-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-xs text-gray-500">We'll send booking confirmations to this email</p>
                        </div>
                    ...
                    <div class="space-y-6 pt-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-xs text-gray-500">Username must be unique and contain only letters, numbers, and underscores</p>
                        </div>
                    ...
                    <div class="text-center mt-6">
                        <p class="text-sm text-gray-600">
                            Already have an account? <a href="login.jsp" class="text-indigo-600 hover:text-indigo-800 font-medium">Sign in</a>
                        </p>
                    </div>
                </form>
            </div>
